 ...
 * @author paulorlov
 */
@ActionID(category = "Delete", id = "ru.ptahi.aetexperiment.deleteStimuli")
@ActionRegistration(displayName = "Delete Stimuli", asynchronous=true)
@ActionReferences({
    @ActionReference(path = "myAction/Stimuli", position = 3)
})
