...
class Bundle {
    /**
     * @return <i>ExperimentEditor</i>
     * @see ExperimentEditorTopComponent
     */
    static String CTL_ExperimentEditorAction() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "CTL_ExperimentEditorAction");
    }
    /**
     * @return <i>ExperimentEditor Window</i>
     * @see ExperimentEditorTopComponent
     */
    static String CTL_ExperimentEditorTopComponent() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "CTL_ExperimentEditorTopComponent");
    }
    /**
    ...
    /**
     * @return <i>RunExperiment</i>
     * @see MyPA
     */
    static String CTL_RunExperimentAction() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "CTL_RunExperimentAction");
    }
    /**
     * @return <i>RunExperiment Window</i>
     * @see MyPA
     */
    static String CTL_RunExperimentTopComponent() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "CTL_RunExperimentTopComponent");
    }
    /**
    ...
    /**
     * @return <i>This is a ExperimentEditor window</i>
     * @see ExperimentEditorTopComponent
     */
    static String HINT_ExperimentEditorTopComponent() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "HINT_ExperimentEditorTopComponent");
    }
    /**
    ...
    /**
     * @return <i>This is a RunExperiment window</i>
     * @see MyPA
     */
    static String HINT_RunExperimentTopComponent() {
        return org.openide.util.NbBundle.getMessage(Bundle.class, "HINT_RunExperimentTopComponent");
    }
    /**
